import { loadWordIndexCache, saveWordIndexCache } from "./word-index/cache";
import { makeWordIndexMessageListener } from "./word-index/handler";
import { createWordIndexService } from "./word-index/service";
import {
  getAllBrowserHistory,
  getLatestHistoryByUrl,
  onHistoryVisited,
} from "../common/chrome/chrome-history";
